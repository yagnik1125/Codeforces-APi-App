...
class ProblemsetProblemStatement extends StatefulWidget {
  final dynamic contestid;
  final dynamic problemIndex;
  const ProblemsetProblemStatement(
      {Key? key, required this.contestid, this.problemIndex})
      : super(key: key);

  @override
  State<ProblemsetProblemStatement> createState() =>
      _ProblemsetProblemStatementState();
}

class _ProblemsetProblemStatementState
    extends State<ProblemsetProblemStatement> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Problemset Problem"),
      ),
      body: isLoading
          ? const Center(
