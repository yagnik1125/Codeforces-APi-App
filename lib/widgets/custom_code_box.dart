...
import 'package:apiapp/utils/themes.dart';
import 'package:apiapp/widgets/code_snippets.dart';
...
class _CustomCodeBoxState extends State<CustomCodeBox> {
  ...
  Widget build(BuildContext context) {
    final codeDropdown = buildDropdown(
        languageList, language!, Icons.arrow_drop_down_sharp, (val) {
      if (val == null) return;
